...
Better weak laws can allow some dependence among the observations and usually just require that $\E X_i^2 < \infty$ (a slightly stronger assumption than $\E \lvert X_i \rvert <\infty$). Check out google if you're interested.
...
* Let's unpack the notation $F_n(y) \to F(y)$. This means for any given $y$ and $\epsilon>0$ there exists $N$ such that for all $n\ge N$,
\[
