...
* First, let's choose a distribution (together as a class).
...
<!-- **Theorem (Durett, pg. 73):** Let $X_1, X_2, \ldots$, be iid random variables with $\E X_i = \mu$ and $\E \lvert X_i \rvert <\infty$. -->
...
* Break the law of large numbers
* Start to talk about the central limit theorem
