...
Here is a list of links to the lab activities.
...
* `lab1_2.html` - this is the output from the Rmarkdown file. When you add your answers and hit the knitr button in Rstudio it will compile this file. You can change the format between html/pdf/docx.
